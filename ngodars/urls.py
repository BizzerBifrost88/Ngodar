...
urlpatterns = [
    ...
    path('user-home/hall-list/food-search/<str:search_query>/', views.hall_search, name='hall_search'),
    path('user-home/catering-list/food-search/<str:search_query>/', views.catering_search, name='catering_search'),
    ...
    path('user-home/food-list/location/add-address/', views.add_address, name='add_address'),
    path('user-home/food-list/location/use-address/<int:address_id>/', views.use_address, name='use_address'),
    path('user-home/food-list/location/delete-address/<int:address_id>/', views.delete_address, name='delete_address'),    
